...
void title_wg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        title_wg *_t = static_cast<title_wg *>(_o);
        switch (_id) {
        ...
        {
            typedef void (title_wg::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&title_wg::closeWindow)) {
                *result = 0;
            }
        }
    }
